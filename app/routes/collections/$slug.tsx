...
export async function loader({ params, request, context }: DataFunctionArgs) {
  ...
  if(!params.slug) throw new Response('No slug provided',{
    status: 404,
  });
  const collection = await getCollection(request, params.slug);
    ...
    <div className="max-w-6xl mx-auto px-4">
      ...
      {collection.children?.length ? (
        <div className="max-w-2xl mx-auto py-16 sm:py-16 lg:max-w-none border-b mb-16">
          <h1 className="text-2xl font-light text-gray-900">Collections</h1>
