...
export type CollectionFragment = {
  ...
  productVariants: {
    __typename?: 'ProductVariantList';
    items: Array<{ __typename?: 'ProductVariant'; id: string; name: string }>;
  };
};
...
export type SetOrderCustomFieldsMutation = {
  ...
  setOrderCustomFields:
    | { __typename: 'NoActiveOrderError'; message: string }
...
export type DetailedProductFragment = {
  ...
  customFields?: {
    ...
    maximumFlow?: string | null;
    headsToFeet?: string | null;
    connectionsDischarge?: string | null;
    allowOrder?: boolean | null;
  } | null;
  variants: Array<{
    __typename?: 'ProductVariant';
    id: string;
